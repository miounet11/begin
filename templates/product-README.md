...
开工入口：[begin](https://github.com/miounet11/begin)。本页填空，不要另写第三本手册。
...
**升级到期日：YYYY-MM-DD** ← 必填。没有时钟的级别是一张永久免罪符，门禁会拒。
...
| 问题 | 只读这份 | 不要读 |
|------|----------|--------|
| 怎么开工 / 执行面合同 | [begin AGENTS](https://github.com/miounet11/begin/blob/main/AGENTS.md) | 再写一份「给 AI 的总提示」 |
...
| 创造有没有落成定律 | [creativity-is-engineering](https://github.com/miounet11/creativity-is-engineering) | 聊天里的判断 |
